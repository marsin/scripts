...
caeFilePath = "G:\\Temp\\test.cae"
directory = "G:\\Temp\\square02\\02\\"
splitted = "square02.caesplited.cae"
mdb = openMdb(directory+splitted)
genomes = []
genomeFile = open(directory+"final_4")
...
if (status == str('ABORTED')):
    ...
    tempFile = open('G:\\Temp\\result','w')
    print (str(1/(areaForGene[1]*maxMagnitude)))
    tempFile.close()
